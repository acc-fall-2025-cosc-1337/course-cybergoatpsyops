...
TEST_CASE("Verify get_letter_grade_using_if function", "[decisions]"){

	SECTION ("Test Case 1: Grades"){
...
TEST_CASE("Verify get_letter_grade_using_switch function", "[decisions]"){
	SECTION ("Test Case 2: Grades")[
